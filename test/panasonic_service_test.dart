      ...
      mockClient = MockClient((request) async {
        ...
        if (request.url.toString().contains('aw_ptz') &&
          ...
          return http.Response('"OAW0"', 200);
            ...
            request.url.toString().contains('OGU:10')) {
